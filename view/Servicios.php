...
<head>
    ...
    <title>H M N G | Gestion de Servicios</title>
    ...
    <script type="text/javascript" src="funcionesjs/GestionServicio.js"></script>
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools">
                            ...
                            <a class="" data-toggle="" href="NuevoServicio.php">
                    ...
                    <div class="ibox-content">
                        <?php include "modals/modalServicio.php" ?>
                        ...
                        <div class="table-responsive">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    $objListaServicios = new Listas();
                                    $listaServicios = $objListaServicios ->ListaServicios();
                                    if(!empty($listaServicios)){
                                    foreach ($listaServicios as $row => $link) {
                                    ?>
                                    <tr>
                                        <td hidden="true" class="idservicio"><?php echo $link['idservicios']; ?></td>
                                        <td><?php echo $link['serviciosnombre']; ?></td>
                                        <td><?php echo $link['serviciosdescripcion']; ?></td>
                                        <td>
                                            <div class="input-group-btn ">
                                                <button data-toggle="modal" data-target="#ModalModificar" class=" bt_editarServicio btn btn-warning btn-sm" type="button" ><i class="fa fa-edit"></i></button>
                                                <button data-toggle="modal" data-target="#ModalEliminar"  class="bt_eliminarServicio btn btn-danger btn-sm" type="button" ><i class="fa fa-trash"></i></button>
                                            </div>
                                        </td>    
                                    </tr>
                                <?php
        ...
        $(document).ready(function(){
            $('.dataTables-example').DataTable({
                ...
                buttons: [
                    { extend: 'copy'},
                    {extend: 'csv'},
                    {extend: 'excel', title: 'Lista de Servicios'},
                    {extend: 'pdf', title: 'Lista de Servicios'},
