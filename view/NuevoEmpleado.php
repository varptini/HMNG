...
<head>
    ...
    <title>H M N G |  Alta de Nuevo Empleado</title>
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-sm-6">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <a href="Empleados.php">Gestion de Empleado</a>
                        </li>
                        <li class="active">
               ...
               <div class="row">
                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <form role="form" class="form-horizontal" id="formRegistrarEmpleado" name="formRegistrarEmpleado">
                                <div class="form-group"><label class="col-sm-2 control-label">Nombre</label>
                                    <div class="col-sm-10"><input id="inputNombreEmpleado" name="inputNombreEmpleado"  placeholder="Nombre" autofocus required="true" type="text" class="form-control"></div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group"><label class="col-sm-2 control-label">Direccion</label>
                                    <div class="col-sm-10"><input id="inputDireccionEmpleado" name="inputDireccionEmpleado"  placeholder="Direccion" autofocus required="true" type="text" class="form-control"></div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group"><label class="col-sm-2 control-label">Telefono</label>
                                    <div class="col-sm-10"><input id="inputTelefonoEmpleado" name="inputTelefonoEmpleado"  placeholder="Telefono" autofocus required="true" type="tel" class="form-control"></div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group"><label class="col-sm-2 control-label">Correo electronico</label>
                                    <div class="col-sm-10"><input id="inputEmailEmpleado" name="inputEmailEmpleado"  placeholder="Correo electronico" autofocus required="true" type="email" class="form-control"></div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group"><label class="col-sm-2 control-label">Celular</label>
                                    <div class="col-sm-10"><input id="inputCelularEmpleado" name="inputCelularEmpleado"  placeholder="Celular" autofocus required="true" type="tel" class="form-control"></div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group"><label class="col-sm-2 control-label">Fecha Nacimiento</label>
                                    <div class="col-sm-10"><input id="inputfechaNacEmpleado" name="inputfechaNacEmpleado"  placeholder="Fecha de Nacimiento" autofocus required="true" type="date" class="form-control"></div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group">
