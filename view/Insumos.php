...
<head>
    ...
    <title>H M N G | Gestion de Insumos</title>
     ...
     <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <nav class="navbar navbar-fixed-top  " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <form role="form" id="formBuscarXCodBarra" name="formBuscarXCodBarra" class="navbar-form-custom" >
                    <div class="form-group">
                        <input type="text" placeholder="Buscar por codigo barras..." autofocus="true" class="form-control input-s-sm col-lg-6" id="CodBar" name="CodBar">
                    </div>
                </form>
            </div>
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-sm-4">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <strong>Gestion de Insumos</strong>
                        </li>
                    </ol>
                </div>
            ...
            <div class="wrapper wrapper-content">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Tabla de Insumso Registrados</h5>
                        <div class="ibox-tools">
                            <a class="collapse-link">
                                <i class="fa fa-chevron-up"></i>
                            </a>
                            <a class="" data-toggle="" href="NuevoInsumo.php">
                                <i class="fa fa-plus">  Agregar Insumo</i>
                            </a>
                    ...
                    <div class="ibox-content">
                        <?php include "modals/modalInsumo.php" ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="input-group-btn">
                                        <button title="Agregar" data-toggle="modal" data-target="#ModalStock" class=" bt_AgregarStockInsumo btn btn-success btn-sm" type="button" ><i class="fa fa-plus"></i></button>
                                    </div>
                              </td>
                              <td hidden="true" class="idinsumos "><?php echo $link['idinsumos']; ?></td>
                              ...
                              <td><?php echo $link['insumoscantidadminima']; ?></td>
                              <td><?php echo $link['insumosexistencia']; ?></td>
                              <td>
                                  <div class="input-group-btn">
                                        <button title="Modificar" data-toggle="modal" data-target="#ModalModificar" class=" bt_editarInsumo btn btn-warning btn-sm" type="button" ><i class="fa fa-edit"></i></button>
                                        <button title="Eliminar" data-toggle="modal" data-target="#ModalEliminar"  class="bt_eliminarInsumo btn btn-danger btn-sm" type="button" ><i class="fa fa-trash"></i></button>
                                   </div>
                              </td>    
                            </tr>
                        <?php
