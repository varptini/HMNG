...
<head>
    ...
    <title>H M N G |  Alta de Nuevo Servicio</title>
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-sm-6">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <a href="Servicios.php">Gestion de Servicios</a>
                        </li>
                        <li class="active">
                            <strong>Alta de Nuevo Servicio</strong>
                        </li>
                    </ol>
                </div>
               ...
               <div class="row">
                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>Formato de Registro de Servicio</h5>
                        ...
                        <div class="ibox-content">
                            ...
                            <form role="form" class="form-horizontal"   id="CrearServicio" name="CrearServicio">
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">Nombre del Servicio</label>
                                    <div class="col-sm-10"><input id="inputNombreServicio" name="inputNombreServicio"  placeholder="Nombre del Servicio" autofocus required="true" type="text" class="form-control"></div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group"><label class="col-sm-2 control-label">Descripcion del Servicio</label>
                                    <div class="col-sm-10"><textarea id="textareaDescripcionServicio" name="textareaDescripcionServicio" placeholder="Descripcion" autofocus required="true"   class="form-control"  rows="10" cols="50"></textarea></div>
                                </div>
