...
<head>
    ...
    <title>H M N G | Gestion de Almacenes</title>
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-sm-4">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <strong>Gestion de  Almacenes</strong>
                        </li>
                    </ol>
                </div>
            ...
            <div class="wrapper wrapper-content">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Tabla de servicios registrados</h5>
                        <div class="ibox-tools">
                            <a class="collapse-link">
                                <i class="fa fa-chevron-up"></i>
                            </a>
                            <a class="" data-toggle="" href="NuevoAlmacen.php">
                                <i class="fa fa-plus">  Agregar Almacen</i>
                            </a>
                    ...
                    <div class="ibox-content">
                        <?php include "modals/modalAlmacen.php" ?>
                        ...
                        <div class="table-responsive">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    $objListaAlmacenen = new Listas();
                                    $listaAlmacen = $objListaAlmacenen ->ListaAlmacenes();
                                    if(!empty($listaAlmacen)){
                                    foreach ($listaAlmacen as $row => $link) {
                                    ?>
                                    <tr>
                                        <td hidden="true" class="idalmacen"><?php echo $link['idalmacen']; ?></td>
                                        <td><?php echo $link['almacennombre']; ?></td>
                                        <td><?php echo utf8_encode($link['almacendireccion']); ?></td>
                                        <td><?php echo $link['almacenemail']; ?></td>
                                        <td><?php echo $link['almacentelefono']; ?></td>
                                        <td><?php echo utf8_encode($link['almacenencargado']); ?></td>
                                        <td>
                                            <div class="input-group-btn ">
                                                <button data-toggle="modal" data-target="#ModalModificar" class=" bt_editarAlmacen btn btn-warning btn-sm" type="button" ><i class="fa fa-edit"></i></button>
                                                <button data-toggle="modal" data-target="#ModalEliminar"  class=" bt_eliminarAlmacen btn btn-danger btn-sm" type="button" ><i class="fa fa-trash"></i></button>
                                            </div>
                                        </td>    
                                    </tr>
                                <?php
        ...
        $(document).ready(function(){
            $('.dataTables-example').DataTable({
                ...
                buttons: [
                    { extend: 'copy'},
                    {extend: 'csv'},
                    {extend: 'excel', title: 'Lista de Almacenes'},
                    {extend: 'pdf', title: 'Lista de Almacenes'},
                    {extend: 'print',
