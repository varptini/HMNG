...
<head>
    ...
    <title>H M N G | Gestion de Empleados</title>
    ...
    <script type="text/javascript" src="funcionesjs/GestionEmpleado.js"></script>
...
<!--                <form role="search" class="navbar-form-custom" action="#">
            ...
            <ul class="nav navbar-top-links navbar-right">
                <li>
                    <span class="m-r-sm text-muted welcome-message">Bienvenido al Administrador de Sub Almacen.</span>
                </li>
                <li>
            ...
            <div class="wrapper wrapper-content">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Tabla de Empleados Registrados</h5>
                        <div class="ibox-tools">
                            <a class="collapse-link">
                                <i class="fa fa-chevron-up"></i>
                            </a>
                            <a class="" data-toggle="" href="NuevoEmpleado.php">
                                <i class="fa fa-plus">  Agregar Empleado</i>
                            </a>
                    ...
                    <div class="ibox-content">
                        <?php include "modals/modalEmpleado.php" ?>
                    <label id="Resultado"></label>     
                    <div class="table-responsive">
                    <table  id="dt_Empleados" class="display table table-striped table-bordered table-hover dt_Empleados" style="width:100%" >
                    <thead>
                    <tr>
                    ...
                    <tbody>
                        <?php
                            ...
                            foreach ($listaEmpleados as $row => $link) {
                                if (  $_SESSION["IdEmpleado"]!= $link['idempleado'] ){
                            ?>
                            <tr>
                              <td hidden="true" class="idempleado"><?php echo $link['idempleado']; ?></td>
                              <td><?php echo $link['empleadonombre']; ?></td>
                              <td><?php echo $link['empleadodireccion']; ?></td>
                              <td><?php echo $link['empleadotelefono']; ?></td>
                              <td><?php echo $link['empleadocorreo']; ?></td>
                              <td><?php echo $link['empleadocelular']; ?></td>
                              <td><?php echo $link['empleadofechanacimiento']; ?></td>
                              <td style="text-align:center;">
                                  <div class="input-group-btn ">
                                  <button title="Modificar" data-toggle="modal" data-target="#ModalModificar"class="bt_editarEmpleado btn btn-warning btn-sm" type="button" ><i class="fa fa-edit"></i></button>
                                  <button title="Eliminar" data-toggle="modal" data-target="#ModalEliminar"  class="bt_eliminarEmpleado btn btn-danger btn-sm" type="button" ><i class="fa fa-trash"></i></button>
                                  </div>
                              </td>
                            </tr>
                        <?php
        ...
        $(document).ready(function(){
            ...
            $('.dt_Empleados').DataTable({
                ...
                buttons: [
                    { extend: 'copy'},
                    {extend: 'csv'},
                    {extend: 'excel', title: 'Lista de Empleados'},
                    {extend: 'pdf', title: 'Lista de Empleados'},
