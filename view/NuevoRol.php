...
<head>
    ...
    <title>H M N G |  Alta de Nuevo Cargo</title>
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-sm-6">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <a href="Roles.php">Gestion de Cargos</a>
                        </li>
                        <li class="active">
                            <strong> Alta de Nuevo Cargo</strong>
                        </li>
                    </ol>
                </div>
               ...
               <div class="row">
                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>Formato de Registro de Cargos</h5>
                        ...
                        <div class="ibox-content">
                            ...
                            <form role="form" class="form-horizontal"   id="CrearCargo" name="CrearCargo">
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">Nombre del Cargo</label>
                                    <div class="col-sm-10"><input id="inputNombreCargo" name="inputNombreCargo"  placeholder="Nombre del Cargo" autofocus required="true" type="text" class="form-control"></div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group"><label class="col-sm-2 control-label">Descripcion del Cargo</label>
                                    <div class="col-sm-10"><textarea id="textareaDescripcionCargo" name="textareaDescripcionCargo" placeholder="Descripcion" autofocus required="true"   class="form-control"  rows="10" cols="50"></textarea></div>
                                </div>
