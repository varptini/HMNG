...
<head>
    ...
    <title>H M N G | Gestion de Credenciales</title>
    ...
    <script src="../js/plugins/dataTables/datatablesbootstrap.min.js"></script>
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-sm-4">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <strong>Gestion de Credenciales</strong>
                ...
                <div class="row">
                   ...
                   <div class="ibox float-e-margins">
                       <div class="ibox-title">
                           <h5>Tabla de Credenciales Registradas</h5>
                           <div class="ibox-tools">
                               <a class="collapse-link">
                                   <i class="fa fa-chevron-up"></i>
                               </a>
                               <a class="" data-toggle="" href="NuevoUsuario.php">
                                   <i class="fa fa-plus-square">  Agregar Credencial</i>
                               </a>
                           </div>
                       </div>
                       <div class="ibox-content">
                            <?php include "modals/modalUsuario.php" ?>
                        <label id="Resultado"></label>  
                            <div class="table-responsive">
                            <table class="dt_empleado table table-striped table-bordered table-hover dataTables-example" >
                                <thead>
                                <tr>
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        $objListaUsuarios = new Listas();
                                        $listaUsuarios = $objListaUsuarios ->ListaUsuarios();
                                        if(!empty($listaUsuarios)){
                                        foreach ($listaUsuarios as $row => $link) {
                                            if ($_SESSION["IdUser"]!= $link['idusuario'] ){
                                        ?>
                                        <tr>
                                          <td hidden="true" class="idusuario"><?php echo $link['idusuario']; ?></td>
                                          <td><?php echo $link['usuarionombre']; ?></td>
                                          <td><?php echo $link['usuariocontrasena']; ?></td>
                                          <td><?php echo $link['nombre']; ?></td>
                                          <td><?php echo $link['rol']; ?></td>
                                          <td><?php echo $link['usuariofechacreacion']; ?></td>
                                          <td><?php if($link['usuarioactivo']==1){echo "<span class='badge badge-primary'>Activo</span>";}else{    echo "<span class='badge badge-danger'>No Activo</span>";}  ?></td>
                                          <td style="text-align:center;">
                                              <div class="input-group-btn ">
                                                <button title="Modificar" data-toggle="modal" data-target="#ModalModificar"class=" bt_editarUsuario btn btn-warning btn-sm" type="button" ><i class="fa fa-edit"></i></button>
                                                <button  title="Eliminar" data-toggle="modal" data-target="#ModalEliminar"  class="bt_eliminarUsuario btn btn-danger btn-sm" type="button" ><i class="fa fa-trash"></i></button>
                                              </div>  
                                          </td>    
                                        </tr>
                                    <?php
