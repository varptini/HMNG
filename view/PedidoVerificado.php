...
$search="";
$nombreEmpleado="";
if(isset($_POST['inputidPedidoVerificado'])){
    $search = trim($_POST['inputidPedidoVerificado']);
...
<?php
    ...
    $dompdf->render();
    $pdf = $dompdf->output();
    $path = "archivos/userfiles/files/Pedidos_Verificados";
    $filename="PedidoVerificado_".$servicioNombre."_ID_".$search.".pdf";
